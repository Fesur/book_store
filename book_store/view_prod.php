...
<div class="container-fluid">
    ...
    <p>Precio: <b><?php echo number_format($price,2) ?></b></p>
	<p>Descripcion:</p>
	...
	<div class="d-flex jusctify-content-center col-md-12">
		...
		<button class="btn btn-primary btn-block btn-sm col-sm-4" type="button" id="add_to_cart">Añadir al carrito</button>
	</div>
</div>
<script>
