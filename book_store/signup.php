...
<div class="container-fluid">
	<form action="" id="signup-frm">
		...
		<div class="form-group">
			...
			<?php if(isset($id)): ?>
				<small><i>Deje este campo en blanco si no desea cambiar su contraseña.</i></small>
			<?php endif; ?>
		</div>
		<button class="button btn btn-primary btn-sm"><?php echo !isset($id) ? "Create" : "Update" ?></button>
		<button class="button btn btn-secondary btn-sm" type="button" data-dismiss="modal">Cancelar</button>
