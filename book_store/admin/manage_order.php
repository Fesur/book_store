	...
	<form action="" id="manage-order">
		...
		<div class="col-lg-12">
			<div class="row">
					    			...
					    			<li class="list-group-item" data-id="<?php echo $row['id'] ?>" data-price="<?php echo $row['price'] ?>">
					    				<div class="d-flex w-100">
					    					...
					    					<div class="detail-field">
					    						<p>Libro: <b><?php echo $row['title'] ?></b></p>
					    						<p>Autor: <b><?php echo $row['author'] ?></b></p>
					    						<p>Precio: <b><?php echo number_format($row['price'],2) ?></b></p>
					    						<p>Cantidad: <b><?php echo number_format($row['qty'],2) ?></b></p>
					    					</div>
				...
				<div class="col-md-6">
					<b class="text-muted">Informacion</b>
					<p>Cliente: <b><?php echo ucwords($name) ?></b></p>
					<p>Dirección de entrega: <b><?php echo ucwords($address) ?></b></p>
					<p>Importe total a pagar: <b><?php echo number_format($total,2) ?></b></p>
