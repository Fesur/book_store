						...
						<table class="table table-bordered table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td class="">
										<p>Titulo: <b><?php echo $row['title'] ?></b></p>
										<p><small>Autor: <b><?php echo $row['author'] ?></b></small></p>
										<p><small>Descripcion: <b class="truncate"><?php echo $row['description'] ?></b></small></p>
									</td>
									<td class="">
										<p>
											<b>
									...
									<td class="text-center">
										<button class="btn btn-sm btn-primary edit_book" type="button" data-id="<?php echo $row['id'] ?>">Editar</button>
										<button class="btn btn-sm btn-danger delete_book" type="button" data-id="<?php echo $row['id'] ?>">Borrar</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
