	...
	<form action="" id="manage-book">
		...
		<div class="col-lg-12">
			...
			<div class="row">
				...
				<div class="col-md-6">
					<div class="form-group">
						<label class="label control-label">Precio</label>
